...
INSERT INTO "new_WidgetStyle" ("backgroundColor", "borderColor", "borderRadius", "borderStyle", "borderWidth", "bundleId", "buttonColor", "buttonTextColor", "createdAt", "discountBadgeColor", "discountLabelStyle", "discountTextColor", "fontColor", "fontSize", "id", "imageSize", "layoutType", "marginBottom", "marginTop", "padding", "showCountdownTimer", "subtitleFontSize", "titleFontSize", "updatedAt") SELECT "backgroundColor", "borderColor", "borderRadius", "borderStyle", "borderWidth", "bundleId", "buttonColor", "buttonTextColor", "createdAt", "discountBadgeColor", "discountLabelStyle", "discountTextColor", "fontColor", "fontSize", "id", "imageSize", "layoutType", "marginBottom", "marginTop", "padding", "showCountdownTimer", "subtitleFontSize", "titleFontSize", "updatedAt" FROM "WidgetStyle";
