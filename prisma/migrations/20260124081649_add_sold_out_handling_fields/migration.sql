...
CREATE TABLE "new_Bundle" (
    ...
    "showSoldOutLabel" BOOLEAN NOT NULL DEFAULT false,
    "soldOutLabelText" TEXT NOT NULL DEFAULT 'Sold out',
    "shopifyDiscountId" TEXT
);
INSERT INTO "new_Bundle" ("combineWithOrderDiscounts", "combineWithProductDiscounts", "combineWithShippingDiscounts", "createdAt", "deleteAddOnsWithMain", "endDate", "id", "selectionMode", "shop", "shopifyDiscountId", "startDate", "status", "subtitle", "targetingType", "title", "updatedAt") SELECT "combineWithOrderDiscounts", "combineWithProductDiscounts", "combineWithShippingDiscounts", "createdAt", "deleteAddOnsWithMain", "endDate", "id", "selectionMode", "shop", "shopifyDiscountId", "startDate", "status", "subtitle", "targetingType", "title", "updatedAt" FROM "Bundle";
DROP TABLE "Bundle";
